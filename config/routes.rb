Rails.application.routes.draw do
  ...
  get "question_2_1/:id" => "analysis#question_2_1"
...
#  get "home/top" => "home#top"
  ...
  post "create_2_1/:id" => "analysis#create_2_1"
  post "create_3/:id" => "analysis#create_3"
  post "create_4/:id" => "analysis#create_4"
  post "create_5/:id" => "analysis#create_5"
###  post "create_6/:id" => "analysis#create_6"
  post "create_6/:id" => "analysis#result"
